...
TEST(LibWriteTests, createDirectoryTest1){ //Fixed
        std::string wad_path = setupWorkspace();
        Wad* testWad = Wad::loadWad(wad_path);
...
TEST(LibWriteTests, createFileTest6){
        ...
        //createFile Test 6, passing invalid name in E#M# format. Telling me to create a file named E1M1 in the root directory 
        std::string testPath = "/E1M1";
